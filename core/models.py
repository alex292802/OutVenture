...
class Review(models.Model):
    ...
    date = models.DateField(auto_now=True) # auto_now adds automatically the actual date when saving
    rating = models.SmallIntegerField(validators=[MinValueValidator(0), MaxValueValidator(5)])
    comment = models.TextField(max_length=1000, blank=True, null=True) # TODO: prevent user to input more characters than max_length. 
